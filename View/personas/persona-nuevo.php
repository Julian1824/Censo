...
<!--
                ...
                $data->TFNO
-->
<form id="formulario" action="?c=personas&a=Guardar" method="post" enctype="multipart/form-data">

    <div class="form-group">
      <label>Cédula</label>
      <input type="text" id="DNI" name="DNI" value="<?php echo $pvd->DNI; ?>" class="form-control" placeholder="Cedula Usuario" data-validacion-tipo="requerido|min:20" />
    </div>
    ...
    <div class="form-group">
        ...
        <input type="date" name="FECNAC" value="<?php echo $pvd->FECNAC; ?>" class="form-control" placeholder="Fecha nacimiento Usuario" data-validacion-tipo="requerido|min:100" />
    </div>

    <div class="form-group">
        <label>Dirección</label>
        <input type="text" id="direcc" name="DIR" value="<?php echo $pvd->DIR; ?>" class="form-control" placeholder="Dirección Usuario" data-validacion-tipo="requerido|min:10" />
    </div>
    <div class="form-group">
        <label>Teléfono</label>
        <input type="text" id="tel" name="TFNO" value="<?php echo $pvd->TFNO; ?>" class="form-control" placeholder="Teléfono usuario" data-validacion-tipo="requerido|min:10" />
    </div>
